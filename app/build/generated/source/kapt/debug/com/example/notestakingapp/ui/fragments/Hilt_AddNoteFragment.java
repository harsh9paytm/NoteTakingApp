...
public abstract class Hilt_AddNoteFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddNoteFragment() {
    super();
  }

  Hilt_AddNoteFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddNoteFragment_GeneratedInjector) this.generatedComponent()).injectAddNoteFragment(UnsafeCasts.<AddNoteFragment>unsafeCast(this));
    }
  }
