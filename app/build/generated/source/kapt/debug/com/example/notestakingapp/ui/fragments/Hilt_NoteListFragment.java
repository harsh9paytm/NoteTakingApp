...
public abstract class Hilt_NoteListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NoteListFragment() {
    super();
  }

  Hilt_NoteListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoteListFragment_GeneratedInjector) this.generatedComponent()).injectNoteListFragment(UnsafeCasts.<NoteListFragment>unsafeCast(this));
    }
  }
