...
public abstract class Hilt_NoteDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NoteDetailFragment() {
    super();
  }

  Hilt_NoteDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoteDetailFragment_GeneratedInjector) this.generatedComponent()).injectNoteDetailFragment(UnsafeCasts.<NoteDetailFragment>unsafeCast(this));
    }
  }
